...
static bool is_type_null(const std::string &input) { return (input == "null"); }
...
static bool is_type_array(const std::string &input) { return (input == "["); }

// returns true if input represents an object json type
static bool is_type_object(const std::string &input) { return (input == "{"); }
...
static bool is_close_array(const std::string &input) { return (input == "]"); }

// returns true if input represents the close of a json object
static bool is_close_object(const std::string &input) { return (input == "}"); }

// returns true if input represents the json comma separator
static bool is_comma(const std::string &input) { return (input == ","); }

// returns true if input represents the json colon separator between a
// {"key":"value"} pair
static bool is_colon(const std::string &input) { return (input == ":"); }
