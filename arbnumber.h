...
public:
  ArbNumberException(const std::string &msg_) : msg(msg_) {}
...
public:
  ...
  ArbNumber(const double initial) : ArbNumber(std::to_string(initial)) {}
  ...
  bool operator==(const double rhs) const { return (*this) == ArbNumber(rhs); }

  bool operator!=(const ArbNumber &rhs) const { return !(*this == rhs); }
  ...
  ArbNumber operator+(const double rhs) const { return *this + ArbNumber(rhs); }

  ArbNumber operator-(const ArbNumber &rhs) const { return (*this) + (-rhs); }
  ...
  bool is_zero() const { return whole.empty() && fractional.empty(); }
...
public:
  ...
  static ArbNumber abs(const ArbNumber &rhs) { return rhs.abs(); }

  static ArbNumber ceil(const ArbNumber &rhs) { return rhs.ceil(); }

  static ArbNumber floor(const ArbNumber &rhs) { return rhs.floor(); }

  static std::string to_string(const ArbNumber &rhs) { return rhs.to_string(); }
};
