...
template <typename T, typename U> class Comparable2 {
public:
  virtual int compareTo(const T &rhs) const = 0;
...
template <typename T, typename U, typename V> class Comparable3 {
public:
  virtual int compareTo(const T &rhs) const = 0;
  virtual int compareTo(const U &rhs) const = 0;
...
template <typename T, typename U, typename V, typename W> class Comparable4 {
public:
  virtual int compareTo(const T &rhs) const = 0;
  virtual int compareTo(const U &rhs) const = 0;
  virtual int compareTo(const V &rhs) const = 0;
...
template <typename T> class MathOperators {
public:
...
template <typename T, typename U> class MathOperators2 {
public:
  virtual T negate() const = 0;
  virtual void increment() = 0;
  virtual void decrement() = 0;
...
template <typename T, typename U, typename V> class MathOperators3 {
public:
  virtual T negate() const = 0;
  virtual void increment() = 0;
  virtual void decrement() = 0;
...
template <typename T, typename U, typename V, typename W> class MathOperators4 {
public:
  virtual T negate() const = 0;
  virtual void increment() = 0;
  virtual void decrement() = 0;
